<h1 align = "center">🌟LilyGO T-Watch K230🌟</h1>


[![PlatformIO CI](https://github.com/Xinyuan-LilyGO/TTGO_TWatch_Library/actions/workflows/platformio.yml/badge.svg)](https://github.com/Xinyuan-LilyGO/TTGO_TWatch_Library/actions/workflows/platformio.yml)[![Arduino_CI](https://github.com/Xinyuan-LilyGO/TTGO_TWatch_Library/actions/workflows/arduino_ci.yml/badge.svg?branch=t-watch-s3)](https://github.com/Xinyuan-LilyGO/TTGO_TWatch_Library/actions/workflows/arduino_ci.yml)

<!-- **[English](README.MD) | 中文** -->

## News:
T-Display K230是继K210之后的另一款基于嘉楠科技的新芯片K230而设计的。
我们在保留K230的基本外设功能外，增加了LILYGO产品特色的lora功能，同时外观设计基于手持设备的尺寸设计，可以选配高显示质量的4.05寸AMOLED屏幕，基于AMOLED屏幕我们工程写了对应的应用Demo供开发参考。
LORA+ISP摄像头的组合特点，让我们尝试开发基于lora的不同的应用吧
